...
RUN set -x \
  ...
  && export GNUPGHOME="$(mktemp -d)" \
  && gpg --keyserver hkp://p80.pool.sks-keyservers.net:80 --recv-keys C874011F0AB405110D02105534365D9472D7468F || \
    gpg --keyserver hkp://ipv4.pool.sks-keyservers.net:80 --recv-keys C874011F0AB405110D02105534365D9472D7468F || \
    gpg --keyserver hkp://pgp.mit.edu:80 --recv-keys C874011F0AB405110D02105534365D9472D7468F \
